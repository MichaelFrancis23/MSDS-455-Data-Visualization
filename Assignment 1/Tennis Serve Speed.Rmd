...
michaelServesByGame$in_out <- ifelse(michaelServesByGame$in_out==1, "Out", "In")
...
```{r pressure, echo=FALSE, fig.height=7, fig.width=15}
grid.arrange(p1, p2, ncol=2)
```

- 2nd serves tend to be slower than 1st serves but are hit in more often
- Over time, players get tired and serve slower
